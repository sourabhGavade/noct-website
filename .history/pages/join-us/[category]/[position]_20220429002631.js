...
export default function JoinTheNetworkInner({ position, category }) {
  ...
  function getProcessData() {
    if(router.query.position.toLowerCase().includes('front-end-developer')){
      category.process[2].title = 'Assignment'
      category.process[2].description = 'You will be assigned a task to showcase your coding skills in frontend technologies (HTML, CSS, JavaScript, React).'
