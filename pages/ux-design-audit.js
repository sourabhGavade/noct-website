...
export default function UXDesignAudit() {
        ...
        <div className="container">
          <div className="row align-items-center justify-content-between w-100">
            <div className="col-lg-6">
              <div className="h1 mb-3"><LetteringTitle text="What is a UX design audit?" /></div>
              <p className="lg" data-fade-up>
                Network of Creative Thinkers is a design agency that partners with startups and corporates. Network of Creative Thinkers is a design agency that partners with startups and corporates.
              </p>
            </div>
      ...
      <section className="padded-section bg-grey">
        <div className="container">
          <div className="row align-items-center justify-content-between">
            <div className="col-lg-4">
              <div className="h2 mb-5">Let's talk about your UX Audit.</div>
              <Link href="/contact">
                <a>
