  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="A design agency in the cloud with a studio in the hills, that crafts digital experiences, weaves intricate tales and builds brands from the ground up."
        />
        <meta
          property="og:title"
          content="NOCT | Network of Creative Thinkers | We craft digital products &amp; brands"
        />
        <meta
