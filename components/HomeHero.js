...
export default function HomeHero({ awards }) {
  ...
  const initBlob = () => {
    if (window.innerWidth < 768) {
      gsap.to("#blobOne", {
        ...
        attr: {
          r: "80px",
          cx: `${window.innerWidth}px`,
          cy: `${window.innerHeight - 240}px`,
        },
      });
    } else {
      gsap.to("#blobOne", {
        ...
        attr: {
          r: "210px",
          cx: `${0.75 * window.innerWidth - 105}px`,
          cy: `${0.5 * window.innerHeight - 50}px`,
        },
  ...
  const handleMouseMove = (e) => {
    gsap.to("#blobOne", {
      duration: 0.3,
      attr: { cx: `${e.clientX}px`, cy: `${e.pageY}px` },
    });
  };
  ...
  return (
    <>
      {/* Page */}
      <section
        className="hero-section home-hero-section flex-center"
        onMouseLeave={() => heroMouseLeave()}
        onMouseEnter={() => heroMouseEnter()}
        style={{ height: "100vh" }}
      >
        ...
        <div
          className="hero-fixed-banner cursor-pointer"
          onMouseLeave={() => bannerMouseLeave()}
          onMouseEnter={() => bannerMouseEnter()}
          onClick={() => bannerClick()}
        >
          <div className="dot" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-9 col-xl-6">
              ...
              <p className="mb-4 lg">
                A design agency in the cloud with a studio in the hills, that
                crafts digital experiences, weaves intricate tales and builds
