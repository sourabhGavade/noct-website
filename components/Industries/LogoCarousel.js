  ...
  return (
    <section className="logo-carousel tw-overflow-hidden tw-pb-8 md:tw-pb-[60px]">
      ...
      <div className="logo-carousel__viewport tw-relative tw-w-full tw-overflow-hidden">
        <div className="logo-carousel__track tw-flex tw-w-max tw-items-center md:tw-gap-[85px] tw-gap-[43px]">
          {track.map((logo, index) => {
            ...
            return (
              <div
                ...
                className="logo-carousel__item tw-flex tw-shrink-0 tw-items-center tw-justify-center"
              >
                <img
                  src={src}
                  alt={logo.alt || ""}
                  className="md:tw-w-[140px] tw-object-contain tw-w-[84.48px]"
                  loading="lazy"
                />
              </div>
            );
